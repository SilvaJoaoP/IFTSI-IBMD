...
  const inputStyledClasses = "w-full border border-gray-300 rounded-lg px-4 py-2.5 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 bg-white transition-all duration-200";

  return (
    {/* ALTERAÇÃO AQUI: bg-[#bfe8ff] foi substituído por bg-white */}
